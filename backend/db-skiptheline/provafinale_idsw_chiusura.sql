...
CREATE TABLE `chiusura` (
  ...
  PRIMARY KEY (`ID_Supermercato`,`Giorno`),
  CONSTRAINT `ID_Supermercato` FOREIGN KEY (`ID_Supermercato`) REFERENCES `supermercato` (`ID`)
...
INSERT INTO `chiusura` VALUES (1,'SABATO'),(1,'VENERDI'),(2,'SABATO'),(5,'MARTEDI');
