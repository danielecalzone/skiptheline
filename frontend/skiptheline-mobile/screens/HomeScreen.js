    ...
    <>
      {!fontsLoaded || isLoading ? (
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.subtitle}>Dove sei diretto oggi?</Text>
          ...
          <View style={{ alignItems: "center", marginVertical: 15 }}>
            <Image
              style={[styles.tinyLogo, {width : deviceWidth * 90 / 100, height: deviceHeight * 25 / 100}]}
          ...
          {noData ? (
            ...
            <>
              <Text style={styles.text}>Supermercati vicino a te :</Text>
              <FlatList
                  data={
