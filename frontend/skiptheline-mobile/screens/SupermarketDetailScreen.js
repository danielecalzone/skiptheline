          ...
          <View style={{ margin: 20 }}>
            ...
            >
              <View style={{ flexDirection: "column" }}>
                ...
                <Text style={styles.description}>Persone in coda</Text>
              </View>
              ...
              <View style={{ flexDirection: "column" }}>
                <Text>
                  ...
                  <Text style={styles.text}> minuti</Text>
                </Text>
                <Text style={styles.description}>Tempo di attesa stimato</Text>
              </View>
            </View>
            ...
            >
              <View style={{ flexDirection: "column" }}>
                ...
                <Text style={styles.description}>Capienza</Text>
              </View>
              ...
              <View style={{ flexDirection: "column" }}>
                ...
                <Text style={styles.description}>Affluenza supermercato </Text>
              </View>
            </View>
            ...
            >
              <View style={{ flexDirection: "column" }}>
                ...
                <Text style={styles.description}>Giorno di chiusura</Text>
              </View>
              <View style={{ flexDirection: "column" }}>
                ...
                <Text style={styles.description}>Orari di apertura/chiusura</Text>
              </View>
            </View>
            ...
            <View style={{ justifyContent: "flex-end" }}>
              <Button
                ...
                disabled={
                  supermarketDetail.supermarket.stato == "CHIUSO" ? true : false
                }
